...
function renderProfile(){
  ...
  box.innerHTML = `
    <div class="profile-card">
      ...
      <div>
        <h2 data-no-translate>${currentUser.name || t('userRole')}</h2>
        <p><strong>${t('profileEmail')}:</strong> <span data-no-translate>${currentUser.email || ''}</span></p>
        <p><strong>${t('profileRole')}:</strong> ${t('userRole')}</p>
